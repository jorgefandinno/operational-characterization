...
\begin{frame}{Well-founded operator reloaded}{Alternative definition}
  ...
  \item <3-> \structure{Properties}
    \begin{itemize}\normalsize
    \item The least fixpoint  of $\hat{\Omega}_P$ corresponds to the well-founded semantics of $P$
      \smallskip
    \item Total fixpoints of $\hat{\Omega}_P$ correspond  to the stable models of $P$
    \end{itemize}
  \end{itemize}
